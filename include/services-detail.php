...
if (!empty($_GET["seflink"])) {
    ...
    $data = $DB->getAll("services", "WHERE seflink=? AND state=?", array($seflink, 1), "ORDER BY ID ASC", 1);
    if ($data) {
                ...
                <div class="row align-items-center">
                    ...
                    ?>
                        <div class="col-xl-6 col-md-6">
                            <<img src="<?= SITE ?>images/services/<?= $data[0]["image"] ?>" style="width:100%; height:auto;">
                        </div>
